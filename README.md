...
```nix
programs.skillnet.skillsRoot = "/data/nvme0/can/Projects/repos/owned/codeberg.org/caniko/ai-skills";
```
...
- `programs.skillnet.skillsRoot` sets `skills_root` in generated
  ...
  `/data/nvme0/can/Projects/repos/owned/codeberg.org/caniko/ai-skills`.
